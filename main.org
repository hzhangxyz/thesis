...
Scalable tensor network algorithm for thermal quantum many-body systems in two dimension. (submitted)
\item Zhang Hao, Dong Shaojun, He Lixin.
Competing phases and suppression of superconductivity in hole-doped Hubbard model on honeycomb lattice. (submitted)
\end{enumerate}
