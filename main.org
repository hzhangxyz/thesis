...
#+begin_export latex
\footnote{
翻译: 我认为总有一天，场论可以用不同于波函数和振幅的方式来描述。它可能类似于密度矩阵，能让你专注于局域的量，使得开始讨论它时，你不必立即去了解其他地方发生了什么。
}{
``
...
结果发现，在低掺杂浓度下，基态呈现 {{{AFM}}} 序，然而随着掺杂浓度的增加，这一秩序逐渐减弱，并最终在掺杂浓度 $\delta>0.05$ 时消失。
...
尽管 {{{SU}}} 方法非常高效，并且在许多模拟有限温度系统的研究中表现出色[[cite:Schmoll2024]]，但它们通常只在低纠缠态下表现良好。
...
\begin{enumerate}
\item 2024年以第一作者在 Computer Physics Communications 发表论文一篇。
\item 2023年以第二作者在 Chinese Physics Letters 发表论文一篇。
\item 2022年以第四作者在 Physical Review A 发表论文一篇。
\item 2022年以第三作者在 Physical Review A 发表论文一篇。
\item 2022年以第四作者在 Physical Review B 发表论文一篇。
\end{enumerate}
...
\item 一篇第三作者论文 submitted。
\item 一篇共同第一作者（排名第二）论文 submitted。
\end{enumerate}
