...
值得注意的是，虽然对纠缠对的投影可以构造任意图结构的张量网络，但是 {{{PEPS}}} 通常用于 {{{L4}}} 的结构。
...
一种针对费米子的张量网络态可以解决这个问题 [[cite:Dong2019,Zhang2024]] 。
...
\end{equation}
我们也可以将其中的某些替换成费米子的纠缠对，这样依然可以保持这些纠缠对整体的玻色性质 [[cite:Dong2019,Zhang2024]] 。
