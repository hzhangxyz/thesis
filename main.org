...
经过单核10步采样后进行性能分析，结果列于表 [[ref:table:最开始的profiling]] 中。
...
| 热点函数                    | 来源    | 运行时间   |     占比 |
|---------------------------+--------+----------+---------|
| =xGEMM=                   | BLAS   | 2763.53s |  52.36% |
| =xCOPY=                   | BLAS   | 662.46s  |  12.55% |
| =xGEMV=                   | BLAS   | 645.60s  |  12.23% |
| =xGER=                    | BLAS   | 457.72s  |   8.67% |
| =xLASR=                   | LAPACK | 96.94s   |   1.83% |
| =permutation_rank3_data3= | 张量转置 |          |         |
|---------------------------+--------+----------+---------|
| 合计                       |        | 5277.54s | 100.00% |
|---------------------------+--------+----------+---------|
