...
尽管在半填充时观察到在约 $U_c = 3.8$ 处有从半金属到反铁磁态的相变 [23,24] ，但关于掺杂对六角晶格上Hubbard模型中的反铁磁态的影响仍然没有彻底研究。
...
此外，参考文献 [25] 中使用的GTPS使用了简单更新算法，在时间演化过程中涉及近似处理，可能影响结果的准确性。
